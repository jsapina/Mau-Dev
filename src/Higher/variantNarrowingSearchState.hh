...
public:
  ...
  //
  bool findNextVariant(Vector<DagNode*>& variantExtOld, Vector<DagNode*>& variantExtSub, int& variantEq, DagNode*& variantTerm, Vector<DagNode*>& variantSubstitution /*, int& nrFreeVariables */); //MAU-DEV
