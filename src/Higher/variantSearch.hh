...
public:
  ...
  const Vector<DagNode*>* getNextVariant(Vector<DagNode*>& variantExtOld, Vector<DagNode*>& variantExtSub, int& variantEq, int& nrFreeVariables, int& variableFamily, int& parentIndex, bool& moreInLayer); //MAU-DEV
  ...
  //
  const Vector<DagNode*>* getLastReturnedVariant(Vector<DagNode*>& variantExtOld, Vector<DagNode*>& variantExtSub, int& variantEq, int& nrFreeVariables, int& variableFamily, int& parentIndex, bool& moreInLayer); //MAU-DEV
  //
...
private:
  ...
  Vector<DagNode*> protectedExtOld; //MAU-DEV
  Vector<DagNode*> protectedExtSub; //MAU-DEV
};
...
VariantSearch::getLastReturnedUnifier(int& nrFreeVariables, int& variableFamily)
{
  ...
  return variantCollection.getLastReturnedVariant(dummyVariantExtOld, dummyVariantExtSub, dummyVariantEq, nrFreeVariables, variableFamily); //MAU-DEV
}
