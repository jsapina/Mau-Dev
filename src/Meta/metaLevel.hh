...
public:
  ...
  DagNode* upVariantExt(const Vector<DagNode*>& variantExtOld, const Vector<DagNode*>& variantExtSub, int variantEq, Int64 solutionNr, const Vector<DagNode*>& variant, const NarrowingVariableInfo& variableInfo, int variableFamilyName, const mpz_class& parentIndex, bool moreInLayer, MixfixModule* m);
  DagNode* upSubstitution(const Vector<DagNode*>& substitution, const VariableInfo& variableInfo, int nrVariables, MixfixModule* m, PointerMap& qidMap, PointerMap& dagNodeMap);
  DagNode* upSubstitution(const Vector<DagNode*>& substitution, MixfixModule* m, PointerMap& qidMap, PointerMap& dagNodeMap);
  /*** END MAU-DEV ***/
  ...
  DagNode* upVariant(const Vector<DagNode*>& variant, 
		     ...
		     MixfixModule* m);
  /*** BEGIN MAU-DEV ***/
  DagNode* upVariantExt(const Vector<DagNode*>& variantExtOld, 
...
private:
  ...
  /*** BEGIN MAU-DEV ***/
  int countHoles(DagNode* dagNode);
  void getOutermost(DagNode* dagNode, PointerSet& outers);
  /*** END MAU-DEV ***/
