...
//
     ...
     // MAU-DEV
     MACRO(itraceStepSymbol, FreeSymbol, 0, 3)
     MACRO(nilITraceSymbol, Symbol, 0, 0)
     MACRO(itraceSymbol, Symbol, SymbolType::ASSOC, 2)
     MACRO(noIdentitySymbol, Symbol, 0, 0)
     MACRO(variantSymbolExt, FreeSymbol, 0, 9)
     MACRO(legacyVariantSymbolExt, FreeSymbol, 0, 9)