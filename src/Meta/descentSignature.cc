...
//
  ...
  /*** BEGIN MAU-DEV ***/
  MACRO(metaAssociative, 2)
  MACRO(metaCommutative, 2)
  MACRO(metaConstructor, 2)
  MACRO(metaIdentity, 2)
  MACRO(metaRightIdentity, 2)
  MACRO(metaLeftIdentity, 2)
  MACRO(metaOutermost, 2)
  MACRO(metaReducePath, 3)
  MACRO(metaString, 3)
  MACRO(metaMap, 2)
  MACRO(metaGetVariantExt, 5)
  MACRO(metaGetIrredundantVariantExt, 5)
  MACRO(legacyMetaGetVariantExt, 5)
  MACRO(legacyMetaGetIrredundantVariantExt, 5)
  /*** END MAU-DEV ***/