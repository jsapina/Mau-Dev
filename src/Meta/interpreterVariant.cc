		  ...
		  if (lastSolutionNr == solutionNr)
		    {
		      ...
		      //
		      variant = vs->getLastReturnedVariant(variantExtOld, variantExtSub, variantEq, nrFreeVariables, variableFamily, parentIndex, moreInLayer); //MAU-DEV
		    }
		  else
		    {
		      while (lastSolutionNr < solutionNr)
			{
			  variant = vs->getNextVariant(variantExtOld, variantExtSub, variantEq, nrFreeVariables, variableFamily, parentIndex, moreInLayer); //MAU-DEV
			  if (variant == 0)
			    {
